...
public class Document2Json {
    ...
    public static JSONArray toJSON(DocumentCollection dc) throws Exception {
    ...
    public static JSONObject toJSON(Document doc) throws Exception {
        Item item = null;
        ...
        try {
            for (Object o : doc.getItems()) {
                ...
                item = (Item) o;
                if (!PATTERN_TABLE.matcher(item.getName()).matches()) continue;
    ...
    public static void toJSONFile(Document doc, String path) throws Exception {
        toJSONFile(doc, path, StandardCharsets.UTF_8);
    }
    ...
    public static void toJSONFile(DocumentCollection dc, String path) throws Exception {
        toJSONFile(dc, path, StandardCharsets.UTF_8);
    }
