  ...
  "options": [ //数组类型，各数据库归档配置
    {
      ...
      "domino_before_prepared_driver": "com.rjsoft.archive.BeforePreparedRJDoc", //1. 不配置：仅导出正文附件； 2. 配置com.rjsoft.archive.BeforePreparedRJDoc,正文附件，流程，意见，办理单； 3. 配置com.rjsoft.prepared.BeforeArchive，正文附件，流程，意见。
